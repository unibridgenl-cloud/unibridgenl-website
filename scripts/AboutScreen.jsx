  ...
  return (
    <main style={{overflowX:'clip'}}>
      <PageHero overline="About us" tone="ink"
        ...
        meta={[["map-pin","Amsterdam, the Netherlands"],["file-text","KvK 42087386"],["graduation-cap","16 partner universities"]].map(([i,t])=>(
      ...
      <section style={{maxWidth:'var(--content-max)',margin:'0 auto',padding:'clamp(48px,7vw,96px) var(--gutter-inline) 0',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))',gap:'clamp(28px,4vw,64px)',alignItems:'center'}}>
        ...
        <Reveal delay={140}>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'var(--space-4)'}}>
            {[[16,"partner universities"],[13,"cities in the Netherlands"],[3,"years working in this field"],[5,"applications per student"]].map(([n,l])=>(
              <Tilt key={l} max={3}>
